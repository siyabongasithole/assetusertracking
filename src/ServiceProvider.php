...
use assetmmanagementusertracking\LaravelUserActivity\Console\UserActivityDelete;
use assetmmanagementusertracking\LaravelUserActivity\Console\UserActivityInstall;
