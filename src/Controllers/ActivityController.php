...
use App\Models\User;
use assetmmanagementusertracking\LaravelUserActivity\Models\Log;
...
class ActivityController extends Controller
{
    ...
    private function handleCurrentData(Request $request)
    {
        ...
        if ($currentData) {
            ...
            return ['current_data' => $currentData, 'edit_history' => $editHistory, 'sue' => $table];
        }
        return [];
    }
    ...
    private function handleUserAutocomplete(Request $request)
    {
        ...
        $user = request('user');
        return \App\Models\User::select('id', 'fullname as name', 'email')
